class ImageAdjustWidget extends CTMap.Widget {
    reference() {
    ...
    init() {
        ...
        document.getElementById('closeImgAjustw').onclick = function () {
            that.earth.unusingWidget(that);
        };
...
//# sourceURL=ImageAdjustWidget.js
